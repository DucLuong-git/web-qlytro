    ...
    <>
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-white dark:bg-slate-800 overflow-hidden shadow-xl rounded-[2.5rem] border border-slate-100 dark:border-slate-700/50 p-8 transition-colors">
          ...
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-[2rem] p-8 sm:p-10 mb-10 relative overflow-hidden shadow-xl shadow-emerald-500/20">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-emerald-50 font-medium text-lg leading-relaxed max-w-2xl">Hệ thống Cổng Thông Tin sẽ tự động tổng hợp phí điện nước, phòng lưu trú của bạn tháng này.</p>
              </div>
